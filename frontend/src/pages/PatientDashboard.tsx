    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          <Link to="/patient/doctors" className="px-6 py-4 bg-brand-500 text-white font-bold rounded-2xl shadow-xl shadow-brand-100 hover:bg-brand-600 transition-all flex items-center gap-2 group active:scale-95">
      ...
      <div className="grid lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="flex items-center justify-between">
            ...
            <Link to="/patient/appointments" className="text-sm font-bold text-brand-600 hover:text-brand-700 flex items-center gap-1 group">
          ...
          <div className="pt-4">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <Link to="/patient/doctors" className="p-6 bg-brand-50 rounded-3xl border border-brand-100 hover:bg-brand-100 transition-all group">
              ...
              <Link to="/patient/records" className="p-6 bg-medical-soft rounded-3xl border border-teal-100 hover:bg-teal-50 transition-all group">
        ...
        <div className="space-y-8">
          <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm">
            ...
            <Link to="/patient/records" className="w-full mt-8 py-4 bg-slate-50 text-slate-600 font-bold rounded-2xl hover:bg-slate-100 transition-all flex items-center justify-center gap-2">
              View All Records
            </Link>
          </div>
