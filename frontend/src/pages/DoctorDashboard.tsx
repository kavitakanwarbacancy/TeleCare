    ...
    <div className="flex items-center gap-5">
      <div className="relative">
        <img 
          ...
          alt={patient} 
          className="w-14 h-14 rounded-2xl object-cover border-4 border-slate-50 shadow-sm"
        />
            ...
            <div className="space-y-8">
              {['David Miller', 'Sophia Garcia', 'James Taylor'].map(name => (
                <div key={name} className="flex items-center justify-between group cursor-pointer">
                  <div className="flex items-center gap-4">
                    <img src={`https://picsum.photos/seed/${name}/100/100`} className="w-12 h-12 rounded-2xl object-cover shadow-sm" alt={name} />
                    <div>
