            ...
            <tbody className="divide-y divide-slate-50">
                ...
                <tr key={doctor.id} className="hover:bg-slate-50/50 transition-colors group">
                  <td className="px-6 py-5">
                    <div className="flex items-center gap-4">
                      <img src={doctor.avatar} className="w-12 h-12 rounded-2xl object-cover shadow-sm" alt={doctor.name} />
                      <div>
              ...
              {[
                ...
                <tr key={i} className="hover:bg-slate-50/50 transition-colors group">
                  <td className="px-6 py-5">
                    <div className="flex items-center gap-4">
                      <img src={`https://picsum.photos/seed/doc${i+10}/100/100`} className="w-12 h-12 rounded-2xl object-cover shadow-sm" alt={doc.name} />
                      <div>
