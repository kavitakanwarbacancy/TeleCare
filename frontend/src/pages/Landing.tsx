    ...
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <nav className="max-w-7xl mx-auto px-6 h-24 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Link to="/login" className="px-6 py-3 text-slate-600 font-semibold hover:text-brand-500 transition-colors">Login</Link>
          <Link to="/signup" className="px-8 py-3 bg-brand-500 text-white font-bold rounded-full shadow-lg shadow-brand-100 hover:bg-brand-600 hover:shadow-brand-200 transition-all active:scale-95">Get Started</Link>
        </div>
      </nav>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/signup" className="px-10 py-5 bg-brand-500 text-white text-lg font-bold rounded-full shadow-xl shadow-brand-100 hover:bg-brand-600 hover:shadow-brand-200 transition-all flex items-center justify-center gap-2 group">
                Book an Appointment <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </Link>
              <Link to="/patient/doctors" className="px-10 py-5 bg-white text-slate-900 border-2 border-slate-100 text-lg font-bold rounded-full hover:bg-slate-50 transition-all flex items-center justify-center gap-2">
                Find a Doctor
              </Link>
            </div>
          </motion.div>
          ...
          <div className="bg-brand-600 rounded-[48px] p-12 lg:p-24 text-center relative overflow-hidden shadow-2xl shadow-brand-200">
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/signup" className="px-12 py-5 bg-white text-brand-600 text-lg font-bold rounded-full hover:bg-brand-50 transition-all shadow-xl">
                  Create an Account
                </Link>
                <Link to="/doctor/dashboard" className="px-12 py-5 bg-brand-700 text-white text-lg font-bold rounded-full hover:bg-brand-800 transition-all border border-brand-500">
                  Join as a Doctor
                </Link>
              </div>
            </div>
