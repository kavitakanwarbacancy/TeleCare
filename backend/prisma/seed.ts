...
async function main() {
  ...
  const CITY_LIST = ["Delhi", "Mumbai", "Bangalore", "Hyderabad", "Pune", "Jaipur", "Ahmedabad", "Lucknow"] as const;
  ...
  const patientSeeds = [
    ...
    },
    {
      ...
      email: "shreya.banerjee@test.com",
    ...
    },
    {
      ...
      email: "siddharth.malhotra@test.com",
